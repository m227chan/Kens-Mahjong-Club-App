...
export const updateWindRotationSettings = backend.updateWindRotationSettings
...
export const setCurrentCompetition = backend.setCurrentCompetition
export const reopenTournament = backend.reopenTournament
export const updateTournamentDuration = backend.updateTournamentDuration
export const endTournament = backend.endTournament
export const deleteTournament = backend.deleteTournament
...
export const subscribeWindRotationSettings = backend.subscribeWindRotationSettings
