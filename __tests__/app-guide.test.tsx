...
describe('AppGuide', () => {
  ...
  it('welcomes a first-time user and spotlights the app guide button', async () => {
    ...
    expect(await screen.findByRole('heading', { name: 'Welcome to Mahjong Messiah' })).toBeInTheDocument()
    ...
    expect(screen.queryByRole('heading', { name: 'Welcome to Mahjong Messiah' })).not.toBeInTheDocument()
  })
  ...
  it('spotlights real application elements and exits to the dashboard', async () => {
    ...
    expect(TOUR_STEP_COUNT).toBe(30)
