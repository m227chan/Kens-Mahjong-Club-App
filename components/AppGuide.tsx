...
const GUIDE_SECTIONS = [
  ...
  { icon: '⏱️', title: 'Session tracker', body: 'The Player deep dive inside Analytics includes net point change over the last 24 hours, 48 hours, 7 days, or a custom From/To date range—not season standings. Use the game-by-game breakdown and press Float to pin a compact chip on this club’s pages.' },
