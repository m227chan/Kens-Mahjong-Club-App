...
const GUIDE_SECTIONS = [
  ...
  { icon: '📅', title: 'Seasons and tournaments', body: 'A season is a chapter of regular club standings. Managers can also start a named tournament with its own scores, ratings, and standings. Both remain available from the Season selector without mixing tournament results into individual competition totals. Choose All seasons to combine every season and tournament in the leaderboard and analytics.' },
...
const TOUR_STEPS: TourStep[] = [
  ...
  { selector: '[data-tour="season-selector"]', title: 'Switch competition history', body: 'Use the Season selector to review regular seasons and tournaments. Starting either competition is a manager action in Settings; the tour will not change it.', action: 'next' },
  ...
  { selector: '[data-tour="settings-modal"]', title: 'You know the core workflow', body: 'Settings is where managers start seasons or tournaments, configure club house scoring and custom leaderboard titles, and perform sensitive club actions. Ming never clicks those actions, and this tour has made no data writes.', action: 'finish', instruction: 'Finish returns you safely to your dashboard.' }
]
