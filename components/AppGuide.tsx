...
const GUIDE_SECTIONS = [
  ...
  { icon: '📅', title: 'Seasons and tournaments', body: 'A season is a chapter of regular club standings. Managers can also start a named tournament with its own scores, ratings, and standings. Both remain available from the Season selector without mixing tournament results into regular club totals.' },
