...
const GUIDE_SECTIONS = [
  ...
  { icon: '📊', title: 'Score Calculator', body: 'Build melds, set your roll position and flowers, and stack handbook patterns into a fan total. Calculate score sums what you have now; Find winning paths shows compatible patterns that meet—or could meet—your club minimum. Open it from Club tools, the wiki, or Calculate fan while recording a win.' },
...
const TOUR_STEPS: TourStep[] = [
  ...
  { selector: '[data-tour="score-calculator-open"]', title: 'Open the score calculator', body: 'Build melds, set roll position and flowers, and total fan from handbook patterns—or explore winning paths against this club’s minimum.', action: 'click', instruction: 'Click Score Calculator.' },
  { selector: '[data-tour="score-calculator-modal"]', title: 'Calculate fan while you play', body: 'Use Calculate score for a finished hand or Find winning paths while tiles are still open. Ming will not change your inputs or record a game.', action: 'next' },
